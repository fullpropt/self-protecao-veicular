    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-section">
                ...
                <ul class="nav-menu">
                    <li class="nav-item"><a href="inbox.html" class="nav-link active"><span class="icon icon-inbox"></span>Inbox<span class="badge" id="unreadBadge" style="display:none;">0</span></a></li>
                </ul>
            </div>
            <div class="nav-section">
            ...
            <div class="nav-section">
                ...
                <ul class="nav-menu">
                    ...
                    <li class="nav-item"><a href="configuracoes.html#copys" class="nav-link" title="Copys e Mensagens"><span class="icon icon-templates"></span>Modelos</a></li>
                </ul>
            </div>
        </nav>
