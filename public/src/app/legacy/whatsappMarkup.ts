        ...
        <div class="whatsapp-grid">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-header-icon green"><span class="icon icon-whatsapp"></span></div>
                ...
                <div class="card-body">
                    ...
                    <div id="disconnected-state">
                        <div class="qr-container">
                            ...
                            <p class="qr-timer" id="qr-timer" style="display: none;">
                                Por segurança, o QR Code será atualizado em <strong id="timer-countdown">30</strong> segundos
                            </p>
                            
                            <button class="btn btn-whatsapp" id="connect-btn" onclick="startConnection()">Conectar WhatsApp</button>
                        </div>
                        ...
                        <div class="instructions">
                            ...
                            <div class="instruction-step">
                                ...
                                <span class="step-text">Clique em "Conectar WhatsApp" acima</span>
                            </div>
                            <div class="instruction-step">
                                <span class="step-number">2</span>
                                <span class="step-text">Abra o WhatsApp no seu celular</span>
                            </div>
                            <div class="instruction-step">
                                <span class="step-number">3</span>
                                <span class="step-text">Vá em Configurações > Dispositivos conectados</span>
                            </div>
                            <div class="instruction-step">
                                <span class="step-number">4</span>
                                <span class="step-text">Toque em "Conectar dispositivo"</span>
                            </div>
                            <div class="instruction-step">
                                <span class="step-number">5</span>
                                <span class="step-text">Escaneie o QR Code que aparecer</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="connected-state" style="display: none;">
                            <div class="connected-state">
                                <div class="connected-avatar">OK</div>
                            <h3>WhatsApp Conectado!</h3>
                            <p>Seu WhatsApp está conectado e pronto para uso</p>
                            
                            <div class="connected-info">
                                <div class="connected-info-row">
                                    <span class="connected-info-label">Nome</span>
                                    <span class="connected-info-value" id="user-name">-</span>
                                </div>
                                <div class="connected-info-row">
                                    <span class="connected-info-label">Número</span>
                                    <span class="connected-info-value" id="user-phone">-</span>
                                </div>
                                <div class="connected-info-row">
                                    <span class="connected-info-label">Status</span>
                                    <span class="connected-info-value" style="color: var(--success);">Online</span>
                                </div>
                            </div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-header-icon blue"><span class="icon icon-contacts"></span></div>
