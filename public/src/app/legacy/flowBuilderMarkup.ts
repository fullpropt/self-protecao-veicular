export const flowBuilderMarkup = `
<style>
...
<!-- Sidebar -->
    <nav class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="app.html#/conversas"><span class="icon icon-message"></span> Conversas</a></li>
            <li><a href="app.html#/flow-builder" class="active"><span class="icon icon-flows"></span> Fluxos</a></li>
