...
<!-- Sidebar -->
    <nav class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="conversas-v2.html" class="active"><span class="icon icon-message"></span> Conversas</a></li>
            <li><a href="flow-builder.html"><span class="icon icon-flows"></span> Fluxos</a></li>
