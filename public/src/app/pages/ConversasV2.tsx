      ...
      `}</style>
          <nav className="sidebar">
              ...
              <ul className="sidebar-menu">
                  ...
                  <li><a href="#/conversas-v2" className="active"><span className="icon icon-message"></span> Conversas</a></li>
                  <li><a href="#/flow-builder"><span className="icon icon-flows"></span> Fluxos</a></li>
