// Logo SVG embutido como data URL para funcionar tanto em dev quanto em produção
// (publicDir: false no vite.config.ts impede que arquivos estáticos de public/ sejam copiados para dist/)
