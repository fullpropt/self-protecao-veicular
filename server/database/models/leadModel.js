        ...
        async delete(id) {
            return await transaction(async (client) => {
                ...
                const cleanupStatements = [
                    ...
                    'UPDATE incoming_message_receipts SET conversation_id = NULL WHERE conversation_id IN (SELECT id FROM conversations WHERE lead_id = $1)',
        ...
        async bulkDelete(ids = []) {
            ...
            return await transaction(async (client) => {
                const cleanupStatements = [
                    ...
                    'UPDATE incoming_message_receipts SET conversation_id = NULL WHERE conversation_id IN (SELECT id FROM conversations WHERE lead_id = ANY($1::int[]))',
