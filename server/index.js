...
const { createAdminDashboardManagementRoutes } = require('./routes/adminDashboardManagementRoutes');
...
app.use(createPublicCheckoutRoutes({
    PreCheckoutLead,
    pagarmeCheckoutService,
    parsePositiveIntInRange,
    upsertCheckoutRegistrationFromPagarmePayload
}));


app.use(createWhatsAppSessionRoutes({
    authenticate,
    requireActiveWhatsAppPlan,
    resolveSessionIdOrDefault,
    resolveRequesterOwnerUserId,
    WhatsAppSession,
    normalizeOwnerUserId,
    sessions,
    sessionStartupErrors,
    sessionInitLockTimestamps,
    sessionInitLocks,
    getSessionDispatchState,
    ...
    parsePositiveIntInRange,
    runSessionReconnectCatchup,
    planLimitsService,
    removeSessionCompletely,
    disconnectSessionPreservingRecord,
...
app.use(createAuthRoutes({
    ...
    upsertCheckoutRegistrationFromPagarmePayload,
    upsertCheckoutRegistrationFromStripePayload,
    normalizeCheckoutRegistrationStatusValue,
    resendCheckoutRegistrationConfirmation,
    MailMktIntegrationError,
    isEmailConfirmed,
    createEmailConfirmationTokenPayload,
    normalizeOwnerUserId,
    ...
    hashEmailConfirmationToken,
    tokenFingerprint,
    resolveCheckoutRegistrationPlanStatus,
    isCheckoutRegistrationExpired,
    isEmailConfirmationExpired,
    getCheckoutRegistrationProvider,
    applyPagarmePlanSettingsToOwner,
    applyStripePlanSettingsToOwner,
    markUserPresenceOnline,
    normalizePresenceUserId,
    USER_PRESENCE_TTL_MS,
    markUserPresenceOffline,
    isApplicationAdminUser,
    verifyPassword,
    generateToken,
    generateRefreshToken,
    hashPassword,
...
app.use(createUserManagementRoutes({
    authenticate,
    resolveRequesterOwnerUserId,
    normalizeUserRoleInput,
    normalizeUserActiveInput,
    isSameUserOwner,
    isUserActive,
    isUserAdminRole,
    isPrimaryOwnerAdminUser,
    countActiveAdminsByOwner,
    sanitizeUserPayload,
    markUserPresenceOffline,
    User,
    hashPassword
...
app.use(createDashboardReadRoutes({
    authenticate,
    resolveRequesterOwnerUserId,
    getScopedUserId,
    senderAllocatorService,
...
app.use(createCustomEventRoutes({
    authenticate,
    resolveRequesterOwnerUserId,
    CustomEvent,
...
app.use(createCampaignReadRoutes({
    authenticate,
    getScopedUserId,
    resolveRequesterOwnerUserId,
    Campaign,
    canAccessCreatedRecord,
    attachCampaignSenderAccountsList,
    attachCampaignQueueStateList,
    attachCampaignSenderAccounts,
    attachCampaignQueueState,
    resolveCampaignLeadIds,
    parseCampaignTagFilters,
    query
}));
...
app.use(createAdminDashboardManagementRoutes({
    authenticate,
    ensureApplicationAdmin,
    User,
    normalizeOwnerUserId,
